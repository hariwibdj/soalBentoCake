...
{
	//	Variabel $hargaSatuan berisi harga satuan bento cake.

	//	Menghitung tagihan awal dengan mengalikan jumlah pesanan dengan harga satuan.
...
$hargaSatuan = 90000; // Harga satuan bento cake dalam rupiah

//	Variabel untuk menyimpan ongkos kirim berdasarkan lokasi.

//	Variabel untuk menyimpan total tagihan.
...
$berkas = "data.json"; // Path file untuk menyimpan data pemesanan
//	Variabel untuk menyimpan data pemesanan.
...
<body>
	...
	if (isset($_POST['Pesan'])) {
		...
		if ($dataPesanan['lokasi'] == "Tanggerang") {
			$ongkir = 5000; // Ongkos kirim untuk Jakarta
		} elseif ($dataPesanan['lokasi'] == "Bogor") {
			$ongkir = 10000; // Ongkos kirim untuk Bandung
		} else {
			$ongkir = 0; // Jika lokasi tidak valid, ongkos kirim diatur ke 0
		}
